			...
			<Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
				<SheetContent side="right" className="sm:max-w-md p-0 [&>button]:hidden flex flex-col" style={style}>
					<SheetHeader className="flex flex-row items-center justify-between p-4 h-16 shrink-0">
						<SheetTitle>{t("sys.notifications.title")}</SheetTitle>
						<Button
							variant="ghost"
							size="icon"
					...
					<SheetFooter className="flex flex-row h-16 w-full items-center justify-between p-4 shrink-0">
						<Button variant="outline" className="flex-1 mr-2">
							{t("sys.notifications.archiveAll")}
						</Button>
						<Button className="flex-1 ml-2">{t("sys.notifications.markAllAsRead")}</Button>
					</SheetFooter>
				</SheetContent>
			</Sheet>
		</>
				...
				<div className="flex-1 min-w-0">
						...
						<div className="mt-3 p-3 bg-bg-neutral rounded-lg">
							<div className="flex items-center justify-between">
								...
								<Button variant="outline" size="sm">
									{t("sys.notifications.actions.viewProfile")}
								</Button>
							</div>
						</div>
					)}
					...
					{notification.hasActions && (
						<div className="mt-3 flex space-x-2">
							<Button size="sm">{t("sys.notifications.actions.accept")}</Button>
							<Button variant="outline" size="sm">
								{t("sys.notifications.actions.decline")}
							</Button>
						</div>
					)}
					...
					{notification.hasReply && (
						<div className="mt-3">
							<div className="flex items-center space-x-2">
								<Input placeholder={`${t("sys.notifications.actions.reply")} `} />
